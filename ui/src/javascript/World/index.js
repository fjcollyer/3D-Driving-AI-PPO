...
import startImg from '../../images/boyShrugging.png';
...
export default class
{
    ...
    setStartingScreen()
    {
        ...
        this.startingScreen.area = this.areas.add({
            ...
            halfExtents: new THREE.Vector2(8, 3),
            hasKey: false,
            testCar: false,
            active: false
        })
        ...
        this.startingScreen.loadingLabel.geometry = new THREE.PlaneBufferGeometry(4, 4 / 4)
        ...
        this.startingScreen.startLabel.geometry = new THREE.PlaneBufferGeometry(4, 4 / 4)
        ...
        this.startingScreen.startLabel.image.src = startImg;
